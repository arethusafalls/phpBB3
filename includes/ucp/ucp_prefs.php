		...
		switch ($mode)
		{
			...
			case 'view':
				...
				*/
				...
				$sort_by_topic_text = array('c' => $user->lang['SORT_TOPIC_TIME'], 'a' => $user->lang['AUTHOR'], 't' => $user->lang['POST_TIME'], 'r' => $user->lang['REPLIES'], 's' => $user->lang['SUBJECT'], 'v' => $user->lang['VIEWS']);
