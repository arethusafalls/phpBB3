...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'anavaro.eventmedals.ajaxyfy' => 'getAnavaro_Eventmedals_AjaxyfyService',
            'anavaro.eventmedals.listener' => 'getAnavaro_Eventmedals_ListenerService',
            'auth' => 'getAuthService',
            ...
            'bb3mobi.lastpostavatar.listener' => 'getBb3mobi_Lastpostavatar_ListenerService',
            ...
            'posey.multiranks.admin.controller' => 'getPosey_Multiranks_Admin_ControllerService',
            'posey.multiranks.listener' => 'getPosey_Multiranks_ListenerService',
            'posey.multiranks.ucp.controller' => 'getPosey_Multiranks_Ucp_ControllerService',
    ...
    /**
     * Gets the 'anavaro.eventmedals.ajaxyfy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \anavaro\eventmedals\controller\ajaxify A anavaro\eventmedals\controller\ajaxify instance.
     */
    protected function getAnavaro_Eventmedals_AjaxyfyService()
    {
        return $this->services['anavaro.eventmedals.ajaxyfy'] = new \anavaro\eventmedals\controller\ajaxify($this->get('auth'), $this->get('cache'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), './../', 'php', 'phpbb_');
    }

    /**
     * Gets the 'anavaro.eventmedals.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \anavaro\eventmedals\event\main_listener A anavaro\eventmedals\event\main_listener instance.
     */
    protected function getAnavaro_Eventmedals_ListenerService()
    {
        return $this->services['anavaro.eventmedals.listener'] = new \anavaro\eventmedals\event\main_listener($this->get('auth'), $this->get('cache'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), './../', 'php', 'phpbb_');
    }
    ...
    /**
     * Gets the 'bb3mobi.lastpostavatar.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \bb3mobi\lastpostavatar\event\listener A bb3mobi\lastpostavatar\event\listener instance.
     */
    protected function getBb3mobi_Lastpostavatar_ListenerService()
    {
        return $this->services['bb3mobi.lastpostavatar.listener'] = new \bb3mobi\lastpostavatar\event\listener($this->get('user'), $this->get('path_helper'));
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('', 'root', '', 'phpbb', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('anavaro.eventmedals.listener', 'anavaro\\eventmedals\\event\\main_listener');
        $instance->addSubscriberService('bb3mobi.lastpostavatar.listener', 'bb3mobi\\lastpostavatar\\event\\listener');
        ...
        $instance->addSubscriberService('posey.multiranks.listener', 'posey\\multiranks\\event\\listener');
    ...
    {
        return $this->services['gfksx.thanksforposts.controller.toplist'] = new \gfksx\ThanksForPosts\controller\toplist($this->get('config'), $this->get('dbal.conn'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('cache.driver'), './../', 'php', $this->get('pagination'), $this->get('gfksx.thanksforposts.helper'), $this->get('request'), $this->get('controller.helper'), 'phpbb_thanks', 'phpbb_users', 'phpbb_posts');
    }
    ...
    {
        return $this->services['gfksx.thanksforposts.helper'] = new \gfksx\ThanksForPosts\core\helper($this->get('config'), $this->get('dbal.conn'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('cache.driver'), $this->get('request'), $this->get('notification_manager'), $this->get('controller.helper'), $this->get('dispatcher'), './../', 'php', 'phpbb_', 'phpbb_thanks', 'phpbb_users', 'phpbb_posts', 'phpbb_notifications');
    }
    ...
    {
        return new \gfksx\ThanksForPosts\notification\thanks($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \gfksx\ThanksForPosts\notification\thanks_remove($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    /**
     * Gets the 'posey.multiranks.admin.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \posey\multiranks\controller\admin_controller A posey\multiranks\controller\admin_controller instance.
     */
    protected function getPosey_Multiranks_Admin_ControllerService()
    {
        return $this->services['posey.multiranks.admin.controller'] = new \posey\multiranks\controller\admin_controller($this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), './../', 'php');
    }

    /**
     * Gets the 'posey.multiranks.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \posey\multiranks\event\listener A posey\multiranks\event\listener instance.
     */
    protected function getPosey_Multiranks_ListenerService()
    {
        return $this->services['posey.multiranks.listener'] = new \posey\multiranks\event\listener($this->get('template'), $this->get('dbal.conn'), $this->get('config'), './../');
    }

    /**
     * Gets the 'posey.multiranks.ucp.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \posey\multiranks\controller\ucp_controller A posey\multiranks\controller\ucp_controller instance.
     */
    protected function getPosey_Multiranks_Ucp_ControllerService()
    {
        return $this->services['posey.multiranks.ucp.controller'] = new \posey\multiranks\controller\ucp_controller($this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), './../', 'php');
    }
